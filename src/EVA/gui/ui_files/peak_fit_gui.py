...
class Ui_peak_fit(object):
    def setupUi(self, peak_fit):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -49, 422, 776))
        ...
        self.verticalLayout_121.addWidget(self.peak_menu_widget)
        ...
        self.verticalLayout_121.addWidget(self.peak_params_tabs)
        ...
        self.verticalLayout_121.addWidget(self.bg_params_tabs)
