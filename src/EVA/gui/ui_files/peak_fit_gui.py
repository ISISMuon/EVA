...
class Ui_peak_fit(object):
    def setupUi(self, peak_fit):
        ...
        self.plot_widget = QtWidgets.QWidget(parent=peak_fit)
        ...
        self.plot_comp_checkbox = QtWidgets.QCheckBox(parent=self.plot_widget)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 422, 899))
        ...
        self.model_save_load_button = QtWidgets.QWidget(parent=self.model_fit_report_frame)
        ...
        self.verticalLayout_6.addWidget(self.model_save_load_button)
