# Form implementation generated from reading ui file 'peakfit.ui'
#
...
class Ui_peak_fit(object):
    def setupUi(self, peak_fit):
        ...
        self.verticalLayout_12.addWidget(self.plot_container_widget)
        self.plot_comp_checkbox = QtWidgets.QCheckBox(parent=peak_fit)
        self.plot_comp_checkbox.setObjectName("plot_comp_checkbox")
        ...
        self.gridLayout_2.addWidget(self.bg_function_label, 15, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.poly_bg_label, 12, 0, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.save_plot_points_button, 3, 0, 1, 1)
        self.save_fitted_model_button = QtWidgets.QPushButton(parent=self.save_load_buttons)
        self.save_fitted_model_button.setObjectName("save_fitted_model_button")
        self.gridLayout_6.addWidget(self.save_fitted_model_button, 3, 1, 1, 1)
        self.gridLayout_2.addWidget(self.save_load_buttons, 35, 0, 2, 1)
        ...
        self.gridLayout_2.addWidget(self.peak_params_label, 1, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.fit_report_area, 27, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.peak_params_tabs, 5, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.fit_report_label, 26, 0, 1, 1)
        ...
        self.label = QtWidgets.QLabel(parent=self.gaussian_fit_tab)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.gridLayout_2.addWidget(self.label, 8, 0, 3, 1)
        ...
        self.gridLayout_2.addWidget(self.plot_fit_buttons, 16, 0, 1, 1)
        self.widget_2 = QtWidgets.QWidget(parent=self.gaussian_fit_tab)
        ...
        self.gridLayout_2.addWidget(self.widget_2, 11, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.peak_menu_widget, 3, 0, 1, 1)
        ...
        self.widget = QtWidgets.QWidget(parent=self.model_fit_tab)
        ...
        self.bg_params_tabs.setCurrentIndex(1)
        self.peak_params_tabs.setCurrentIndex(1)
    ...
    def retranslateUi(self, peak_fit):
        ...
        self.plot_comp_checkbox.setText(_translate("peak_fit", "Plot Fit Components"))
        ...
        self.save_fitted_model_button.setText(_translate("peak_fit", "Save fitted model to fit table"))
