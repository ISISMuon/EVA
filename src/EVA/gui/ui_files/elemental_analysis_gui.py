...
class Ui_elemental_analysis(object):
    def setupUi(self, elemental_analysis):
        ...
        self.detector_checkboxes_widget = QtWidgets.QWidget(parent=self.widget)
        self.detector_checkboxes_widget.setObjectName("detector_checkboxes_widget")
        self.detector_checkbox_hlayout = QtWidgets.QHBoxLayout(self.detector_checkboxes_widget)
        self.detector_checkbox_hlayout.setObjectName("detector_checkbox_hlayout")
        self.horizontalLayout_3.addWidget(self.detector_checkboxes_widget)
