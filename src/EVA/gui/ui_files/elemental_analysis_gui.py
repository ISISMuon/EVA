...
class Ui_elemental_analysis(object):
    def setupUi(self, elemental_analysis):
        ...
        self.muonic_xray_table_all.setEditTriggers(
        ...
        self.muonic_xray_table_prim.setEditTriggers(
            QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers
        )
        ...
        self.muonic_xray_table_sec.setEditTriggers(
            QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.muonic_xray_table_tertiary.sizePolicy().hasHeightForWidth()
        )
        ...
        self.muonic_xray_table_tertiary.setSizeAdjustPolicy(
            QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustIgnored
        )
        self.muonic_xray_table_tertiary.setEditTriggers(
            QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers
        )
        ...
        self.muonic_xray_table_tertiary.horizontalHeader().setCascadingSectionResizes(
            False
        )
        ...
        self.muonic_xray_table_tertiary.verticalHeader().setCascadingSectionResizes(
            False
        )
        ...
        self.plotted_mu_xrays_table.setEditTriggers(
            QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers
        )
        ...
        self.gamma_table.setEditTriggers(
            QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers
        )
        ...
        self.plotted_gammas_table.setEditTriggers(
            QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers
        )
        ...
        self.detector_checkbox_hlayout = QtWidgets.QHBoxLayout(
            self.detector_checkboxes_widget
        )
    ...
    def retranslateUi(self, elemental_analysis):
        ...
        item.setText(_translate("elemental_analysis", "Error"))
        self.muonic_xrays_tab_menu.setTabText(
            self.muonic_xrays_tab_menu.indexOf(self.tertiary_tab),
            _translate("elemental_analysis", "Tertiary"),
        )
