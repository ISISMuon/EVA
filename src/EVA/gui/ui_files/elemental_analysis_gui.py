# Form implementation generated from reading ui file 'C:\Users\matea\PycharmProjects\EVA\src\EVA\gui\ui_files\elemental_analysis.ui'
#
...
class Ui_elemental_analysis(object):
    def setupUi(self, elemental_analysis):
        ...
        elemental_analysis.resize(923, 661)
        ...
        self.ge1_checkbox = QtWidgets.QCheckBox(parent=self.widget)
        self.ge1_checkbox.setObjectName("ge1_checkbox")
        self.horizontalLayout_3.addWidget(self.ge1_checkbox)
        self.ge2_checkbox = QtWidgets.QCheckBox(parent=self.widget)
        self.ge2_checkbox.setObjectName("ge2_checkbox")
        self.horizontalLayout_3.addWidget(self.ge2_checkbox)
        self.ge3_checkbox = QtWidgets.QCheckBox(parent=self.widget)
        self.ge3_checkbox.setObjectName("ge3_checkbox")
        self.horizontalLayout_3.addWidget(self.ge3_checkbox)
        self.ge4_checkbox = QtWidgets.QCheckBox(parent=self.widget)
        self.ge4_checkbox.setObjectName("ge4_checkbox")
        self.horizontalLayout_3.addWidget(self.ge4_checkbox)
    ...
    def retranslateUi(self, elemental_analysis):
        ...
        self.ge1_checkbox.setText(_translate("elemental_analysis", "2099 (GE1)"))
        self.ge2_checkbox.setText(_translate("elemental_analysis", "3099 (GE2)"))
        self.ge3_checkbox.setText(_translate("elemental_analysis", "4099 (GE3)"))
        self.ge4_checkbox.setText(_translate("elemental_analysis", "5099 (GE4)"))
