...
class TrimPresenter(QWidget):
    def __init__(self, view, model, parent=None):
        ...
        self.view.layer_setup_table.contents_updated_s.connect(
            self.view.layer_setup_table.append_row
        )
        self.view.layer_setup_table.cellClicked.connect(
        ...
        self.view.collapse_expand_implantation_checkbox.checkStateChanged.connect(
    ...
    def close_figures(self):
        ...
        self.model.close_figure(self.view.depth_profile_plot.canvas.figure)
    ...
    def start_sim(self):
        ...
        try:
            ...
            self.view.display_error_message(
                message="Invalid layers specified. All layers must have a thickness, and all layers apart from "
        ...
        if not srimdir_valid or not outputdir_valid:
            self.view.display_error_message(
                message="Could not find SRIM.exe at specified location. "
    ...
    def progress_fn(self, progress: dict):
        ...
        self.view.simulation_progress_label.setText(
            f"Running simulation {n + 1} / {total}"
        )
