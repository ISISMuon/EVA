...
class MainView(QMainWindow):
    ...
    def init_gui(self):
        ...
        self.run_number_label.setSizePolicy(
        ...
        self.get_next_run_button.setSizePolicy(
            QSizePolicy.Policy.MinimumExpanding, QSizePolicy.Policy.MinimumExpanding
        )
        ...
        self.load_next_run_button.setSizePolicy(
            QSizePolicy.Policy.MinimumExpanding, QSizePolicy.Policy.MinimumExpanding
        )
        ...
        self.get_prev_run_button.setSizePolicy(
            QSizePolicy.Policy.MinimumExpanding, QSizePolicy.Policy.MinimumExpanding
        )
        ...
        self.load_prev_run_button.setSizePolicy(
            QSizePolicy.Policy.MinimumExpanding, QSizePolicy.Policy.MinimumExpanding
        )
    ...
    def closeEvent(self, event: QCloseEvent):
        ...
        if (
            not get_config().is_changed()
        ):  # quit immediately if no changes have been made
            event.accept()
            QApplication.quit()
            return
