...
from EVA.gui.dialogs.energy_corrections.energy_corrections_view import (
    EnergyCorrectionsView,
)
...
class EnergyCorrectionsPresenter:
    ...
    def populate_table(self):
        ...
        use_corrections = [
            settings["use_e_corr"] for settings in current_corrections.values()
        ]
    ...
    def on_apply(self):
        try:
            ...
            self.view.display_error_message(
                title="Form error", message="Invalid energy corrections in table!"
            )
