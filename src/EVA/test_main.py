...
logging.basicConfig(filename='G4BL_WINDOW.log', encoding='utf-8', level=logging.DEBUG, filemode="w",
...
if __name__ == "__main__":
    ...
    app = App(sys.argv)
    app.main_window = G4blWindow()
    logger.info("Launching main window.")

    app.main_window.widget().showMaximized()
    sys.exit(app.exec())
